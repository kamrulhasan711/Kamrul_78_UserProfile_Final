...
class AddProfileActivity_DIPTI_ICT_04_05 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_add_profile_dipti_ict0405)
        ...
        findViewById<Button>(R.id.addBtn).setOnClickListener {
            if (validateInputs(nameEditText, emailEditText, dobEditText, districtEditText, mobileEditText)) {
                ...
                val userProfileDIPTIICT0405 = UserProfile_DIPTI_ICT_04_05(name = name, email = email, dob = dob, district = district, mobile = mobile)
                profileViewModel.insertUserProfile(userProfileDIPTIICT0405)
